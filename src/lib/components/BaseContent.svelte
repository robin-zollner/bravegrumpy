<script>
  ...
  const {
    ...
    open = false,
    title = 'title',
    defaultClass = 'text-2xl border-[5px] border-solid border-current border-l-0 px-4 py-1 w-full rounded-[5px] rounded-l-none -ml-[20px] mr-5 hover:scale-105 hover:hue-rotate-30',
